...
*   **多言語対応 (New!)**: UIとAIの議論言語を「日本語」と「英語」でリアルタイムに切り替え可能です。
...
4.  **設定調整**:
    *   **言語切り替え**: ヘッダーの「JP/EN」ボタンでいつでも言語を切り替えられます。
...
現在は **5人村** モードがデフォルトですが、設定で人数を変更可能です。

| アイコン | 役職 | 陣営 | 能力 |
| :---: | :--- | :--- | :--- |
| 🐺 | **人狼** | 人狼 | 夜に1人を襲撃して脱落させる。 |
| 🔮 | **占い師** | 村人 | 夜に1人を占い、人間か人狼かを知る。 |
| 🛡️ | **騎士** | 村人 | 夜に1人を護衛し、人狼の襲撃から守る。 |
| 🧑‍🌾 | **村人** | 村人 | 特になし。議論で人狼を探す。 |
